...
public class Tester {
	...
	public static void main(String[] args) {
		...
		c.addDisk(3, 2);
		c.addDisk(3, 1);
		boolean correct = (c.board[0][0] == 2) && (c.board[1][0] == 1) && (c.board[2][0] == 1) && (c.board[3][0] == 1)
				&& (c.board[3][1] == 1) && (c.board[3][3] == 1) && (c.board[3][2] == 2);
		for (int i = 0; i < 7; i++) {
		...
		// you probably want to comment it again once you are done, otherwise you will
		// be asked each time
		...
		if (correct) {
			System.out.println(
					"movePlayer1 seems to work, you can now uncomment the last two lines of the tester and play against your AI !");
		} else {
